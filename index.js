...
2. Type “ASN Validation Or Creation ”.
3. Chatbot will verify your file.
4. If File is valid then asn will be validated or created successfully.
  ...
  openaiWS.on('open', () => {
    ...
    const initial = {
      ...
      session: {
        ...
        voice: "shimmer",
instructions: `
You are Cara, voice assistant for the Msetu portal.
...
STRICT RULES:
1. You must ALWAYS use the official answers above.
